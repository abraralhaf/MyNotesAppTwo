...
import static com.abraralhaf.mynotesapptwo.db.DatabaseContract.NoteColumns.DATE;
import static com.abraralhaf.mynotesapptwo.db.DatabaseContract.NoteColumns.DESCRIPTION;
import static com.abraralhaf.mynotesapptwo.db.DatabaseContract.NoteColumns.TITLE;
...
public class NoteAddUpdateActivity extends AppCompatActivity implements View.OnClickListener{
 ...
 /*
    ...
    /*
     ...
     deleteNote = 20
      */
    private void showAlertDialog(int sayang) {
        final boolean isDialogClose = sayang == ALERT_DIALOG_CLOSE;
        String dialogTitle, dialogMessage;
        if (isDialogClose) {
            dialogTitle = "Batal";
            dialogMessage = "Apakah anda ingin membatalkan perbahan pada form ?";
        }else{
